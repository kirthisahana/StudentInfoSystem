...
public class ViewStud extends HttpServlet //throws IOException,ServletException,Exception
{
    ...
    out.println("padding: 10px 20px;");
        ...
        out.println("Select Student department to view the marks:<br> ");
        ...
        out.println("Select Student year to view the marks:<br> ");
        ...
        out.println("<option value='1'> 1 </option> ");
         ...
         out.println("</select><br><br>");
          ...
          out.println("Select  section to view the marks:<br> ");
          ...
          out.println("<option value='b'> B section </option> ");
           ...
           out.println("Select  subject to view the marks:<br> ");
         ...
         out.println("<option value='s8'> S8 </option> ");
          ...
          out.println("<option value='s10'> S10 </option> ");
           ...
           out.println("</select>");
           out.println("<br>  <br> ");
           out.println("<input type='button' value='Submit'  onclick='idiotfunc(fnum.value,id1.value, id2.value, id3.value, id4.value)'  id='bb4'> ");
           out.println("</form>");
